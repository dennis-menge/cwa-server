...
public class DiagnosisKeyBuilder implements
    Builder, RollingStartNumberBuilder, TransmissionRiskLevelBuilder, FinalBuilder {

  private static final Logger logger = LoggerFactory.getLogger(DiagnosisKeyBuilder.class);

  private byte[] keyData;
  private long rollingStartNumber;
  private long rollingPeriod = DiagnosisKey.EXPECTED_ROLLING_PERIOD;
  ...
  @Override
  public TransmissionRiskLevelBuilder withRollingStartNumber(long rollingStartNumber) {
  ...
  @Override
  public FinalBuilder withRollingPeriod(long rollingPeriod) {
